...
- Name: buttons.spec.ts >> Estados de Botones >> botón en estado loading muestra texto Cargando
- Location: tests-functional/buttons.spec.ts:143:3
...
Locator: locator('button:has-text("Cargando")')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Cargando")')
