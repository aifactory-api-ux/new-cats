...
- Name: buttons.spec.ts >> Botones - DetalleProducto >> botón Agregar al carrito existe y es clickeable
- Location: tests-functional/buttons.spec.ts:73:3
...
Locator: getByRole('button', { name: /agregar al carrito/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /agregar al carrito/i })
