...
- Name: buttons.spec.ts >> Botones - Componentes UI >> Modal botón cerrar existe
...
Locator: locator('button[aria-label="close"], button:has-text("×"), button:has-text("Cerrar")').first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button[aria-label="close"], button:has-text("×"), button:has-text("Cerrar")').first()
...
- generic [ref=e3]:
  ...
  - main [ref=e12]:
    - generic [ref=e13]:
      - heading "Bienvenido a New Cats" [level=1] [ref=e14]
      - paragraph [ref=e15]: Los mejores productos para tu gato
      - button "Ver Catálogo" [ref=e17] [cursor=pointer]
    - heading "Productos Destacados" [level=2] [ref=e19]
  - contentinfo [ref=e20]:
    - paragraph [ref=e21]: © 2026 New Cats. Todos los derechos reservados.
```
