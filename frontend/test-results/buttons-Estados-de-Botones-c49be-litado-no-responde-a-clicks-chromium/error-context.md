...
- Name: buttons.spec.ts >> Estados de Botones >> botón deshabilitado no responde a clicks
- Location: tests-functional/buttons.spec.ts:134:3
...
Call log:
  - waiting for getByRole('button', { name: /entrar/i }).first()
