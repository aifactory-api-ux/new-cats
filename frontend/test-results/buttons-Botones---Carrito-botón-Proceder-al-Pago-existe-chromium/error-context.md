...
- Name: buttons.spec.ts >> Botones - Carrito >> botón Proceder al Pago existe
- Location: tests-functional/buttons.spec.ts:65:3
...
Locator: getByRole('button', { name: /proceder al pago/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /proceder al pago/i })
  ...
  - navigation [ref=e4]:
    ...
    - generic [ref=e8]:
      ...
      - link "Mi Cuenta" [ref=e11] [cursor=pointer]:
        - /url: /cuenta
  - main [ref=e12]:
    - heading "Carrito de Compras" [level=1] [ref=e13]
    - paragraph [ref=e14]: Tu carrito está vacío.
  - contentinfo [ref=e15]:
    - paragraph [ref=e16]: © 2026 New Cats. Todos los derechos reservados.
```
