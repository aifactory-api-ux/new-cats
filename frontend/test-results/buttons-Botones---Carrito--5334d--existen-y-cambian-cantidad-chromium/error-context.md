...
- Name: buttons.spec.ts >> Botones - Carrito >> botones + y - existen y cambian cantidad
- Location: tests-functional/buttons.spec.ts:57:3
...
Locator: getByRole('button', { name: /\+/i }).first()
Expected: visible
Timeout: 5000ms
